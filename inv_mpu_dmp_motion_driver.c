...
#define GYRO_SF             ((unsigned long)46850825L)

#define FIFO_CORRUPTION_CHECK
#ifdef FIFO_CORRUPTION_CHECK
#define QUAT_ERROR_THRESH       ((unsigned long)1L<<24)
#define QUAT_MAG_SQ_NORMALIZED  ((unsigned long)1L<<28)
