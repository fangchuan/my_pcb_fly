...
#define Ultrasnio_Trigger P7.0

#define OP_CS_H()   (P1.0 = 1)
#define OP_CS_L()   (P1.0 = 0)
#define OP_SCK_H()  (P1.3 = 1)
#define OP_SCK_L()  (P1.3 = 0)
#define OP_MOSI_H() (P1.4 = 1)
#define OP_MOSI_L() (P1.4 = 0)
#define OP_MISO      P1.5
#define OP_RESET_H() (P7.1 = 1)
#define OP_RESET_L() (P7.1 = 0)
